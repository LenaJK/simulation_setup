...
#     fo.write('read_restart '+str(restartfile)+' \n')
    ...
    for ii in range(NproteinB1l-1): 
        fo.write('bond_coeff\t' + str(9*ii+1) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[0,0]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+2) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[0,1]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+3) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[0,2]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+4) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[1,0]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+5) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[1,1]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+6) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[1,2]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+7) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[2,0]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+8) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[2,1]) + '\n' )
        fo.write('bond_coeff\t' + str(9*ii+9) + '\t' + str(bondstrengthB1l) + '\t' + str(res_sB1l[2,2]) + '\n' )
    fo.write(' \n')
    fo.write('#bonds_initialB1 \n')
    for ii in range(NproteinB2-1): 
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+1) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[0,0]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+2) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[0,1]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+3) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[0,2]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+4) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[1,0]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+5) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[1,1]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+6) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[1,2]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+7) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[2,0]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+8) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[2,1]) + '\n' )
        fo.write('bond_coeff\t' + str((NproteinB1l-1)*9+9*ii+9) + '\t' + str(bondstrengthB2) + '\t' + str(res_sB2[2,2]) + '\n' )
    fo.write(' \n')
    fo.write('#bonds_initialC \n')
    for ii in range(NproteinB1r-1): 
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+1) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[0,0]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+2) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[0,1]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+3) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[0,2]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+4) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[1,0]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+5) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[1,1]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+6) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[1,2]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+7) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[2,0]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+8) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[2,1]) + '\n' )
        fo.write('bond_coeff\t' + str(((NproteinB2-1)+(NproteinB1l-1))*9+9*ii+9) + '\t' + str(bondstrengthB1r) + '\t' + str(res_sB1r[2,2]) + '\n' )
    fo.write(' \n')
...
#     fo.write('fix		fNVE	mem	nve/sphere update dipole \n')
    ...
    fo.write(' \n')
    fo.write(' \n')
    fo.write('dump			coords all custom '+str(outputstep) +' output.xyz id mol type x y z mux muy muz \n')
    fo.write('dump_modify     coords sort id \n')
    fo.write('thermo_style    custom step v_E v_P v_K v_Rot temp c_emem c_elj xhi yhi zhi \n')
    fo.write('restart 1000       restart_equi1.dat     restart_equi2.dat \n')
    fo.write(' \n')
    fo.write('\t\t\t##======================================##\n')
    fo.write('\t\t\t## Run Attach \n')
    fo.write('\t\t\t##======================================##\n')
